...
function tryredir() {
    if (redirnow) {
        var   isLockTechnicalOnDiv = document.getElementById("isLockTechnicalOn");
        if(isLockTechnicalOnDiv != null) {
            var isLockTechnicalOn = isLockTechnicalOnDiv.innerText == "1";
            if (isLockTechnicalOn) {
                document.cookie = "isLockExitTriggered=true;samesite=lax;max-age=60*4";
            }
        }
...
if (window.navigator.appName == "Opera") {
    ...
    document.getElementsByTagName("body")[0].onunload = DisplayExitSplash;
}
