...
function(e) {
    ...
    const i = function() {
        ...
        l = /auto|scroll/,
        h = /^tb|vertical/,
        d = /msie|trident/i.test(a.navigator && a.navigator.userAgent),
        f = function(e) {
        ...
        v = function(e) {
            ...
            const t = getComputedStyle(e),
                n = r(e) && e.ownerSVGElement && e.getBBox(),
                o = !d && "border-box" === t.boxSizing,
                c = h.test(t.writingMode || ""),
                a = !n && l.test(t.overflowY || ""),
                v = !n && l.test(t.overflowX || ""),
                g = n ? 0 : f(t.paddingTop),
                m = n ? 0 : f(t.paddingRight),
                y = n ? 0 : f(t.paddingBottom),
                E = n ? 0 : f(t.paddingLeft),
                w = n ? 0 : f(t.borderTopWidth),
                T = n ? 0 : f(t.borderRightWidth),
                x = n ? 0 : f(t.borderBottomWidth),
                z = E + m,
                O = g + y,
                S = (n ? 0 : f(t.borderLeftWidth)) + T,
                B = w + x,
                R = v ? e.offsetHeight - B - e.clientHeight : 0,
                A = a ? e.offsetWidth - S - e.clientWidth : 0,
                C = o ? z + S : 0,
                F = o ? O + B : 0,
                M = n ? n.width : f(t.width) - C - A,
                N = n ? n.height : f(t.height) - F - R,
                k = M + z + A + S,
                _ = N + O + R + B,
                D = Object.freeze({
        ...
        T = function() {
            ...
            return t.some(e => e.skippedTargets.length > 0) && function() {
                ...
                "function" == typeof ErrorEvent ? t = new ErrorEvent("error", {
                    message: n
                }) : (t = document.createEvent("Event"), t.initEvent("error", !1, !1), t.message = n), e.dispatchEvent(t)
            }(), o > 0
        };
    let x;
    const z = [],
...
! function(e) {
    ...
    e.videoImgFallback = function(e) {
        ...
        return n.split("&").forEach(e => {
            ...
            const r = n > -1 ? decodeURIComponent(e.substr(n + 1)) : "",
                i = o.indexOf("[");
            if (-1 === i) t[decodeURIComponent(o)] = r;
            else {
                const e = o.indexOf("]", i),
                    n = decodeURIComponent(o.substring(i + 1, e));
        ...
        function l() {
            if (!flexbe_cli.isInited)
                if ("undefined" != typeof jQuery) {
                    ...
                    flexbe_cli.run.is_screenshoter || (e(), setTimeout(() => e(), 1e3), window.addEventListener("popstate", e)), svg4everybody({
    ...
    lg: {
        init() {
            ...
            $(document).on("click.lightbox", "[data-lg]", t => {
                ...
                t.preventDefault(), e = t.target, l = {
                    x: t.clientX,
                    y: t.clientY
                }
            }), $(document).on("mouseup.lightbox", "[data-lg]", i => {
                const o = e === i.target,
                    s = Math.sqrt((l.x - i.clientX) ** 2 + (l.y - i.clientY) ** 2) < 5;
                if (!o || !s) return;
                const a = $(i.currentTarget),
                    n = a.closest(t),
                    r = a.attr("href"),
                    c = 1 == a.closest("[data-loop]").attr("data-loop"),
                    d = !n.attr("data-lg-single"),
                    g = n.find("[data-lg]").filter((e, l) => {
                        const i = $(l).closest(t),
                            o = i.is(n),
                            s = i.closest(".swiper-slide-duplicate").length;
                        return o && !s
                    }).toArray().map(t => {
                        let e;
                        const l = $(t),
                            i = l.attr("href"),
                            o = l.attr("data-sub-html");
                        return e = o ? l.find(o).html() : l.attr("alt") || l.find("img").attr("alt") || "", c && l.closest("[data-cloned]").length ? null : {
                            src: i,
                            subHtml: e
                        }
                    }).filter(t => t),
                    h = g.findIndex(t => t.src === r) || 0;
                this.openGallery({
                    index: h,
                    dynamicEl: g,
                    enableSlide: d,
        ...
        require(t) {
            $("[data-lg]").length && flexbe_cli.require(["/_s/lib/jquery/lightGallery/css/lightgallery.min.css?2", "/_s/lib/jquery/lightGallery/js/lg-spaced-bundle.min.js?1"], () => {
...
flexbe_cli.helpers = {
    setHref(e, t = !1) {
        ...
        flexbe_cli.is_admin ? flexbe_cli.events.emit("editor_leave_page", {
            href: e
        }) : i.location.host === window.location.host ? t ? i.open(e, "_blank") : i.location.href = e : location.href = e
    },
    gotoLink(e = "", t = !1) {
        if ("string" != typeof e) return !1;
        if (!/#{1,2}.+/.test(e)) return this.setHref(e, t), !0; {
            4 === flexbe_cli.theme_id && $('nav[data-opened="true"]').length && flexbe_cli.events.emit("ui_mobilemenu_close"), 4 !== flexbe_cli.theme_id && $(".mobile-menu.active").length && $(".mobile-menu").removeClass("active").trigger("close");
            const t = (e = e.replace(/^(?:\.\/)#{2}/, "#").trim()).trim().split("#"),
                i = t[t.length - 1];
            if ("" !== t[0] && "./" !== t[0] && t[0] !== location.pathname) return this.setHref(e), !0;
            const l = $(`._anchor[name="${i}"]`),
                n = l.length ? l.closest("[data-id]") : $(`[data-id="${i}"]`),
                o = n.closest(".b_block"),
                r = n.closest(".m_modal");
            if ("cart" === i) flexbe_cli.events.emit("ui_modal_close"), flexbe_cli.events.emit("ui_cart_open");
            else if (o.length) this.bringIntoView(l.length ? l : n), flexbe_cli.events.emit("ui_cart_close"), flexbe_cli.events.emit("ui_modal_close"), setTimeout(() => {
                let e = o;
                if (n && !o.is(n)) {
                ...
                const e = r.data("id");
                this.bringIntoView(l.length ? l : n), flexbe_cli.events.emit("ui_cart_close"), flexbe_cli.events.emit("ui_modal_open", {
                    id: e
                })
    ...
    bringIntoView(e, t) {
        ...
        if (i.length && (t || i.is(":hidden"))) {
            const e = new Event("bringIntoView", {
                bubbles: !0,
                cancelable: !0
            });
            i[0].dispatchEvent(e)
    ...
    preloadImage: async e => new Promise((t, i) => {
        ...
        "decode" in l ? (l.src = e, l.decode().then(n).catch(i)) : (l.onerror = i, l.onload = n, l.src = e)
    }),
    getImageUrl(e, t) {
    ...
    async getImageOptimalSize(e, t = {}) {
        const i = t.height / t.width,
            l = await this.getImageProportion(e) / 100,
            n = Math.min(2, window.devicePixelRatio),
...
! function() {
    const e = [];
    flexbe_cli.require = function(t = "", n = (() => {}), i = 15e3, o = !1) {
        ...
        if (!0 === e[t]) n(!0);
        else if (Array.isArray(e[t])) e[t].push(n);
        else {
            let o, r = !1;
            const s = (n = !0) => {
                if (r) return;
    ...
    flexbe_cli.stat = {
        ...
        reachGoals(t = {}, i = {}) {
            ...
            if (n) try {
                ...
                if (t) {
                    ...
                    const a = document.write;
                    document.write = function(e) {
                        $("body").eq(0).append(e)
                    };
                    const o = $(`<div style="display:none">${t}</div>`);
        ...
        AB: {
            ...
            init() {
                flexbe_cli.events.off("entity_event.abstat").on("entity_event.abstat", (e, {
                    ...
                    if (!i || "onView" !== t || !a.state || !a.first) return;
                    const {
                        abtestId: o,
                        abtestVariant: n
                    } = i;
        ...
        QUIZ: {
                    ...
                    if (this.fixAnswer({
                        ...
                        r.forEach(t => {
                            if (t.variants && t.variants.length) t.variants.forEach(t => {
                                ...
                                let i = t.value || "";
                                ["email", "phone", "name"].includes(t.type) && (i = ""), flexbe_cli.stat.reachGoals(o, {
                                    goalAction: e,
                                    goalValue: i
                                })
                            }
            ...
            fixAnswer({
                ...
                a && i ? n = "/mod/quiz/stat/save/composite/" : i ? n = "/mod/quiz/stat/save/answer/" : a && (n = "/mod/quiz/stat/save/view/"), n && (flexbe_cli.stat.u_id ? s() : flexbe_cli.events.one("user_created", () => {
                    s()
                }))
            }
        }
    ...
    flexbe_cli.locale = Object.assign({
        ...
        init(e = "body") {
            $("[data-lang]", e).each((e, t) => {
                const a = $(t).attr("data-lang"),
                    r = $(t).attr("data-lang-content"),
                    n = String(this.tr(a));
        ...
        animateNumber({
            ...
            if (t !== a)
                if (e._animation && (e._animation.pause(), e._animation.reset()), r && (!a || !t) || l < 3 || "function" != typeof anime) s.text(r ? this.formatMoney(a, {
                    freeLabel: n
                }) : a);
                else {
                    const i = {
                    ...
                    null == c && (c = Math.max(150, Math.min(.3 * l, 650))), null == o && (o = "linear"), e._animation = anime({
                        ...
                        easing: o,
                        update: () => {
                            const e = Math.floor(i.value),
                                t = r ? this.formatMoney(e, {
                                    freeLabel: n
                                }) : e;
                            s.text(t)
                        },
                        complete: () => {
                            const e = r ? this.formatMoney(a, {
                                freeLabel: n
                            }) : a;
                            s.text(e)
                        }
...
flexbe_cli.adaptive = {
    ...
    flexbe_cli.resize = {
        ...
        simulateDocumentResize() {
            ...
            const i = flexbe_cli.is_admin ? 500 : 150,
                t = (i = 0) => {
...
flexbe_cli.scroll = {
    ...
    scrollLock: {
        ...
        locked: !1,
        init() {
            this.loaded || flexbe_cli.require([""], () => {
                this.loaded = !0, scrollLock.addScrollableSelector([".scroller"]), this.locked && scrollLock.disablePageScroll()
            })
        },
        lock() {
    ...
    scrollTo(e, l = {}) {
        ...
        let t, i = 0,
            s = 0,
            n = window.scrollParent(e, "y");
        n && !$(n).is(".b_block, .container-list") || (n = document.scrollingElement);
        const c = n === document.body || n === document.documentElement,
            r = c ? window.innerHeight : n.offsetHeight,
            a = l.padding || 0,
            d = o.offset().top,
            f = e.offsetHeight,
            m = c ? $("html, body") : $(n);
...
function _extends() {
    ...
    flexbe_cli.tip = {
        init(e, o = {}) {
            ...
            const a = $(e),
                s = _extends({}, t, o, {
                    content: null != (n = null != (i = o.content) ? i : a.attr("data-tip")) ? n : e.innerHTML
                });
...
! function() {
    ...
    flexbe_cli.header = {
        ...
        floatingHeader(n) {
            const s = this,
                o = flexbe_cli.responsive && flexbe_cli.run.is_screen_mobile_all;
            ...
            cancelAnimationFrame(a),
                function n() {
                    ...
                    const u = f.tween.start + Math.min(f.tween.height, 150) + 150,
                    ...
                    if (r !== g) {
                        ...
                        if (g) {
                            t = setTimeout(() => {
                                i = !0, s.offset = d[0].offsetHeight, l.css("min-height", `${s.offset}px`), d.addClass("fade-in"), d.addClass("fixed-header"), h.attr("data-contrast", m), f && f.updateTween({
                                    fixed: !0
                                }), d.trigger("transform-header"), e = setTimeout(() => {
                                    d.removeClass("fade-in fade-out"), i = !1
                                }, 300)
                            }, o ? 0 : 300)
                        } else i = !0, s.offset = 0, d.addClass("fade-out"), f && f.updateTween({
                            fixed: !1
                        }), e = setTimeout(() => {
...
flexbe_cli.entity = {
    ...
    initArea(e, t = {}) {
        return !!e && ($(e).toArray().forEach(e => {
            let i;
            const n = $(e);
            if (n.is(".b_block") ? i = "block" : n.is(".m_modal") ? i = "modal" : n.is(".w_widget") ? i = "widget" : (flexbe_cli.element && n.is('[data-is="element"]') || n.is('[data-is="zone"]')) && (i = "element"), i) this.bind(i, n[0], t);
            else {
                const e = n.find(".b_block"),
                    i = n.find(".m_modal"),
                    r = n.find(".w_widget");
            ...
            if (flexbe_cli.element) {
                const e = n.find('[data-is="zone"]'),
                    i = n.find('[data-is="element"]');
    ...
    flexbe_cli.block = {
        ...
        fixCoverHeight(e) {
            [2, 3].includes(flexbe_cli.theme_id) && (null == e && (e = this.$list.find(".b_block")), e.each((e, i) => {
                let t, s = 0,
                    l = flexbe_cli.resize.coverHeight || flexbe_cli.resize.viewportHeight;
                const r = $(i),
                    c = r.find(".cover");
                if (!c.length) return;
                const o = r.prevAll(".b_block");
                t = flexbe_cli.is_admin && r.is('[data-abtest-variant="b"]') ? o.eq(1) : o.eq(0), t = t.filter('[data-b-type*="header"]').not('[data-b-type*="overflow"]'), s = Math.max(0, t.outerHeight() || 0), s < 250 && s < l / 2.5 && (l -= s), c.css({
                    "--coverHeight": `${l}px`
                })
            }))
        },
...
! function() {
    ...
    flexbe_cli.modal = {
        ...
        init() {
            ...
            if (e.service && e.m_id) return this.$list.addClass("noanimate"), this.open({
                id: e.m_id
            }), !1;
            this.dispatchEvents()
        },
        ...
        open({
            ...
            const d = Object.keys(this.opened),
                a = d[d.length - 1];
            return !o.rise && a && a !== e && this.close({
                id: a,
                openId: e
            }), d.includes(e) || n.open({
                fromId: a,
        ...
        close({
            ...
            const {
                modal: o
            } = this.find(e) || {}, i = this.bind(o);
            return o ? i ? (i.close({
                openId: t
            }), i.$area.css("zIndex", ""), !0) : (console.warn("Try to close modal without core object"), !1) : void 0
        },
        bind(t) {
            if (!t) return !1;
...
function() {
    ...
    class r {
        ...
        init() {
            this.methods = (flexbe_cli.vars._group.ecommerce.delivery || []).filter(t => t.enabled), this.cartSettings = flexbe_cli.vars._group.ecommerce.cart || {}, this.enabled = this.methods.length > 0, this.activeMethod = this.methods[0]
        }
        dispatch(t, ...e) {
            const i = this[t];
        ...
        getPrice(t) {
            ...
            if (e) {
                ...
                e.prices.filter(t => "" !== t.from).forEach((r, n) => {
                    e.useMinTotal && !n && +r.from && (c = +r.price, +r.from > i && (d = +r.from)), (t >= +r.from || !n) && (c = +r.price)
                }), e.useNotFixTotal && (m = e.useNotFixTotal);
                const n = e.prices.find(t => 0 === t.price);
                r = e.useNotFixTotal && "" === n.from, n && (o = +n.from || 0, s = Math.max(0, o - t), a = flexbe_cli.locale.formatMoney(o), l = flexbe_cli.locale.formatMoney(s)), d && (u = Math.max(0, d - t), h = flexbe_cli.locale.formatMoney(d), f = flexbe_cli.locale.formatMoney(u))
            }
            return n = flexbe_cli.locale.formatMoney(c, {
                freeLabel: !0
            }), {
                current: c,
                currentFormatted: n,
    ...
    flexbe_cli.widget.cart = new class {
        constructor() {
            $.observable(this), this.delivery = new r(this)
        }
        init() {
        ...
        initList() {
            if (flexbe_cli.is_admin) {
                const e = "ru" === flexbe_cli.locale.language,
                ...
                t = JSON.parse(localStorage.getItem("f_cart")) || [], e = JSON.parse(localStorage.getItem("f_cart_changed")) || [], i = !1, this.emit("list_loaded", {})
            } catch (t) {
                console.error(t)
            }
        }
        ...
        getItem(e, i = null) {
            return t.find(t => i ? t.id === e && String(t.variantId) === String(i) : t.id === e)
        }
        getCount() {
        ...
        addItem(e) {
            ...
            const i = this.getItem(e.id, e.variantId);
            return i ? i.count += e.count : t.push(_extends({}, e)), this.updateList(t), flexbe_cli.stat.ecommerce.add({
                id: e.id,
                variantId: e.variantId,
                title: e.title,
                count: e.count,
        ...
        removeItem(e, i) {
            const r = this.getItem(e, i);
            return !(!r || r.protect) && (t.splice(t.indexOf(r), 1), this.updateList(t), flexbe_cli.stat.ecommerce.remove({
                id: r.id,
        ...
        updateCount({
            ...
            const c = this.getItem(e, i);
            return !!c && ("+" === r ? c.count += 1 : "-" === r && +c.count >= 1 ? c.count -= 1 : (r = parseInt(r, 10), c.count = r || 1), this.updateList(t), c)
        }
        getChangedList() {
            return e
        }
        updateChangedList(t) {
            ...
            if (t.forEach(t => {
                    ...
                    if (i) {
                        ...
                        e[r] = t
                    } else e.push(t), this.dispatch("hidePriceChangedBlock", !1)
        ...
        removeChangedItem(t) {
            const i = e.find(e => e.variantId === t);
            if (!i) return !1;
            e.splice(e.indexOf(i), 1), this.updateChangedList(e)
        }
        resetChangedList() {
        ...
        hidePriceChangedBlock(t) {
            if (i = t, !flexbe_cli.is_admin) try {
                localStorage.setItem("f_cart_hide_change_block", t)
            } catch (t) {}
        }
        getPriceChangedBlockHidden() {
            return i
        }
    }
}();
...
flexbe_cli.cookies = new class {
    ...
    createNotify() {
        ...
        document.addEventListener("scroll", () => {
            ...
            once: !0
        }), $(window).one("DOMContentLoaded", () => {
            let e = 0;
            n.outerWidth(), n.addClass("show"), o.addClass("cookies-warning--show"), n.on("click.cookies", ".cookies-button, .cookies-close", () => {
                n.removeClass("show"), o.removeClass("cookies-warning--show"), localStorage.setItem("f_cookies_allowed", "allowed"), n.off("click.cookies"), setTimeout(() => {
                    n.remove()
                }, 1e3), a()
...
class EntityCore {
    constructor(e, t = {}) {
        const i = $(e),
            ...
            o = "zone" === s ? "e" : s[0],
            a = i.attr(`data-${o}-id`),
            h = i.attr("data-mod-id") || 0,
            r = JSON.parse(i.attr("data-components") || null),
            d = JSON.parse(i.attr(`${o}-type`) || "[]");
        this.require = [], this.$area = i, this.area = i[0], this.$container = i, this.container = e[0], this.$root = i, this.root = i[0], this.inited = !1, this.is = s, this.id = n, this.template_id = a, this.mod_id = h, this.type = d, this.components = r, this.tween = {}, this.isVisible = null, this.inScreen = !1, this.inBeside = !1, this.inView = !1, this.inFocus = !1, this.wasVisible = null, this.wasScreen = !1, this.wasBeside = !1, this.wasView = !1, this.wasFocus = !1, Object.keys(t).forEach(e => {
    ...
    onClose() {}
    init(e, t) {
        null == t && (t = this.inited ? "update" : "init"), "init" === t ? this._onInit(e) : "update" === t && this._onUpdate(e), ("init" === t || e.templateRendered) && flexbe_cli.require(this.require, () => {
            this._onLoad(e)
        })
    }
    destroy(e) {
    ...
    _onLoad(e) {
        this.loaded = !0, this._sendEvent("onLoad", e), this.onLoad(e), this.onReady(e), this.require.length && this.updateTween({
            force: !0
        })
    }
    _onUpdate(e) {
        const t = this.$area.attr("data-mod-id") || 0,
            i = JSON.parse(this.$area.attr("data-components") || null);
        this.modId = t, this.components = i, this.inited = !0, this.updated = !0, e.templateRendered && flexbe_cli.locale.init(this.area), this._sendEvent("onUpdate", e), this.onUpdate(e), (e.templateRendered || e.styleRendered) && this.updateTween({
            force: !0
        })
    }
    _onResize(e = {}) {
    ...
    _onVisible({
        ...
        this.isVisible = e, this._sendEvent("onVisible", {
            state: e,
            first: i
        }), this.onVisible({
            state: e,
...
class BlockCore extends EntityCore {
    ...
    updateTween({
        ...
        if (this.tween.color = "#6a6a6a", this.container) {
            ...
            if (e) this.tween.color = "light" === e ? "#FFF" : "#1B1B1C";
            else {
        ...
        const s = n.area.offsetTop || 0,
            r = (null == (i = n.area.offsetParent) ? void 0 : i.offsetTop) || 0,
            o = Math.max(0, s + r),
            a = n.area.offsetWidth,
            l = n.area.offsetHeight,
            h = !(!a && !l),
            c = null == this.tween.width && null == this.tween.height,
            w = e || a !== n.tween.width || l !== n.tween.height,
            f = h !== n.tween.visible;
        ...
        const d = Math.max(flexbe_cli.resize.viewportHeight - n.tween.height, 0),
            b = 1 / n.tween.height * (flexbe_cli.scroll.latest - n.tween.start),
            _ = function() {
...
class ModalCore extends EntityCore {
    ...
    open({
        ...
        (e.hash || null == e.hash) && (this._prevHash = location.hash, flexbe_cli.lockPopstate = !0, history.pushState(null, null, `#${i}`), flexbe_cli.lockPopstate = !1), this.$area.addClass("show"), this.$list.addClass("show"), $("body").addClass("is-modal-open"), $(".w_cart.show").length && this.$list.addClass("rise"), setTimeout(() => {
            this.$list.addClass("overlay"), this._onOpen({
                data: t
            }), this._onBeside({
                state: !0
            }), this._onScreen({
                ...
                state: !0
            }), "function" == typeof e.onOpen && e.onOpen(this)
    ...
    close({
        ...
        const t = this.lastOptions,
            e = !s && !this.$area.siblings(".show").length;
        ...
        this.$area.removeClass("show"), e && (this.$list.removeClass("show rise overlay"), flexbe_cli.scroll.scrollLock.unlock()), flexbe_cli.run.is_screen_mobile_all && $("body, html").scrollTop(this.lastScroll), $("body").removeClass("is-modal-open"), this._onClose(), this._onBeside({
            state: !1
        }), this._onScreen({
            state: !1
        }), this._onView({
            ...
            state: !1
        }), "function" == typeof t.onClose && t.onClose(this), flexbe_cli.events.emit("modal_closed", {
            id: this.id,
            openId: s
        })
    }
...
class ElementCore extends EntityCore {
    constructor(t, e) {
        super(t, e);
        const i = this.$area.closest(".b_block, .m_modal, .w_widget"),
            n = this.$area.parent().closest("[data-is]"),
    ...
    updateTween({
        ...
        const e = this.container || this.area,
        ...
        if (n && "block" === n.is && o && h) {
            const {
                top: i,
                bottom: n
            } = e.getBoundingClientRect(), s = e.offsetWidth, d = e.offsetHeight, f = flexbe_cli.resize.viewportHeight;
...
flexbe_cli.components = {
    ...
    initComponents({
        ...
        const {
            $area: t
        } = n, o = n.isClone ? `${n.id}_clone${n.isClone}` : n.id, s = n.components;
        let i = !1;
        if ("onUpdate" === e && Array.isArray(this.instances[o]) && this.instances[o].forEach(n => n.destroy()), null == s ? i = "[data-component]" : Array.isArray(s) && (i = s.map(n => `[data-component^="${n}"]`).join(", ")), i) {
            const s = t.find(i).addBack(i).toArray();
            this.instances[o] = s.map(t => {
                let o = [];
                const s = String(t.getAttribute("data-component")).trim(),
                    [i, c] = s.split(":");
...
! function() {
    ...
    window.BaseComponent = class {
        ...
        _syncStates({
            ...
            const i = this.component.offsetWidth,
                t = this.component.offsetHeight,
                e = null == this.componentWidth || null == this.componentHeight,
                n = this.core.isVisible && !(!i && !t),
                o = this.core.inBeside && n,
                h = this.core.inScreen && n,
                a = this.core.inView && n,
                c = this.core.inFocus && n,
                r = this.componentWidth !== i,
                d = this.componentHeight !== t,
                l = s || n && !e && (r || d);
            n && (this.componentWidth = i, this.componentHeight = t), n !== this.isVisible && this._onVisible({
                state: n
            }), l && this._onResize({
                force: s
            }), o !== this.inBeside && this._onBeside({
                state: o,
                force: s
            }), h !== this.inScreen && this._onScreen({
                state: h,
                force: s
            }), a !== this.inView && this._onView({
                state: a,
                force: s
            }), c !== this.inFocus && this._onFocus({
                state: c,
                force: s
            })
        }
        ...
        _onVisible({
            ...
            this.isVisible = s, this.onVisible({
                state: s,
                first: i
            }), s && (this.wasVisible = !0)
        }
...
! function() {
    class i {
        constructor(i, t, e) {
            ...
            const s = window.devicePixelRatio >= 1.5 ? 1960 / window.devicePixelRatio : 1960,
                a = this.$outer.width(),
                o = this.$outer.height(),
                h = this.$outer[0].getBoundingClientRect().top + flexbe_cli.scroll.latest;
            this.blSize = {
                w: a <= s ? a : s
            }, this.blSize.r = this.blSize.w / a, this.blSize.h = this.blSize.r * o, this.blSize.y = this.blSize.r * h, this.winSize = {
        ...
        drawOffscreenImage(i, t) {
            ...
            const e = this.offCtx.canvas.width,
        ...
        fitToOuter() {
            ...
            }, this.blSize.r = this.blSize.w / this.$outer.width(), this.blSize.h = this.blSize.r * this.$outer.height(), this.blSize.y = this.blSize.r * (this.$outer[0].getBoundingClientRect().top + flexbe_cli.scroll.latest), this.winSize = {
                w: flexbe_cli.resize.viewportWidth * this.blSize.r,
                h: flexbe_cli.resize.viewportHeight * this.blSize.r
            ...
            a = this.imgSize.r >= s ? {
                w: this.blSize.w,
                h: this.blSize.w * this.imgSize.r
            } : {
                h: e,
                w: e / this.imgSize.r
    ...
    class t extends BaseComponent {
        ...
        loadImage() {
            ...
            const {
                $component: i
            } = this, t = i.find(".image, .parallax-outer"), e = t.find(".loader-image"), s = e.attr("data-src");
            let a;
            if (s) {
                const i = new Image;
        ...
        imageParallaxInit() {
            ...
            const {
                ...
                $component: e,
                data: s
            } = this, a = t._core && t._core.id || t.getAttribute("data-id");
        ...
        videoParallaxInit() {
            ...
            const i = $(".image-holder, .video_bg_container", this.$component),
                t = i.find(".image"),
                e = i.find(".video_bg_player"),
                s = this.owner._core;
            let a = !1;
    ...
    class t extends BaseComponent {
        ...
        initTimer() {
            ...
            this.$itemDay1 = t.find(".d [data-value]").eq(0), this.$itemDay2 = t.find(".d [data-value]").eq(1), this.$itemDay3 = t.find(".d [data-value]").eq(2), this.$itemHour1 = t.find(".h [data-value]").eq(0), this.$itemHour2 = t.find(".h [data-value]").eq(1), this.$itemMinute1 = t.find(".m [data-value]").eq(0), this.$itemMinute2 = t.find(".m [data-value]").eq(1), this.$itemSecond1 = t.find(".s [data-value]").eq(0), this.$itemSecond2 = t.find(".s [data-value]").eq(1), this.lastOffset = {
                ...
                m: void 0,
                s: void 0
            }, !flexbe_cli.is_admin && "none" !== this.data.on_expired && this.finalDate.getTime() < i.getTime() ? ("element" === this.data.on_expired ? $(this.owner).hide() : $(this.root).hide(), flexbe_cli.block.$blocks.each((t, e) => {
                e._core && e._core.updateTween()
            })) : this.start()
        }
        tick() {
    ...
    class t extends BaseComponent {
        ...
        play(t = !1) {
            this.isAutoplayed = !t, this.isPaused = !1, this.onFrameLoaded(() => {
                if ("custom" === this.type) this.$video[0].play();
        ...
        onPlay() {
            this.autoplay && this.isAutoplayed || (this._sliderAutoplayPrevented = !0, this.$component.trigger("preventSliderAutoplay", {
                state: !0
            }))
        }
        onPause() {
            this._sliderAutoplayPrevented && (this._sliderAutoplayPrevented = !1, this.$component.trigger("preventSliderAutoplay", {
                state: !1
            }))
        }
    }
...
! function() {
    ...
    class e extends BaseComponent {
        ...
        async load(e = !1) {
            ...
            const n = flexbe_cli.helpers.getImageUrl(a, i);
            if (flexbe_cli.is_admin) this.setImage(n);
            else {
                const t = setTimeout(() => {
                    this.setImage(n)
                }, 1500);
                await flexbe_cli.helpers.preloadImage(n), this.setImage(n), clearTimeout(t)
            }
            this.loading = !1, this.$component.trigger("load")
        }
        setImage(t) {
            const e = this.params;
            if (t || (t = flexbe_cli.helpers.getImageUrl(e)), this.isImgLoaded || (this.isImgLoaded = !0, this.$component.removeClass("loading")), this.img && (this.img.src = t), "background" === e.type) {
                const e = `url(${t})`;
...
flexbe_cli.components.classes.rangeInput = class {
    ...
    drawLegend() {
        ...
        const s = [`${this.formatN(this.startEdge)}`.length, `${this.formatN(this.endEdge)}`.length, `${this.formatN(this.step)}`.length],
            n = (s[0] + s[1] + s[2]) / 3,
            i = Math.max(this.startEdge, this.endEdge),
        ...
        const r = Math.ceil(this.$legend.find(s[0] > s[1] ? ".from" : ".to").width() / Math.max(s[1], s[0])),
            o = Math.round(.83 * this.barWidth / (r * n)),
            u = this.range > 0 ? 1 : -1;
        ...
        if (!h || !Number.isInteger(this.range / (h * u)) || this.range / (h * u) < 3)
            for (let t = Math.min(Math.round(this.range / this.step), o, 10); t >= 2; t -= 1) {
    ...
    updateTooltip(t) {
        ...
        if (e && e.length) {
            ...
            let n;
            n = e / 2 > s + this.maxAllowedLeft ? e / 2 - (s - this.maxAllowedLeft) : e / 2 + s > this.maxAllowedRight ? this.maxAllowedRight - s - e / 2 : 0, t.css({
    ...
    setEvents() {
        ...
        this.$component.on("resize", () => {
            ...
            this.startWatchingEvents(), this.applyEndPosition(s - this.defaultShift), t[0].addEventListener("touchmove", this.touchHendler.bind(this), {
                passive: !1
            }), t.on("touchend.range", () => {
            ...
            if (1 !== e.touches.length) return !1;
            e.stopPropagation(), this.updateBarWidth(), this.activeRunner = "end", this.$startRunner.removeClass("upper-runner"), this.$endRunner.addClass("upper-runner"), e.stopPropagation(), this.startWatchingEvents(e.touches[0].pageX - this.$endRunner.offset().left), this.toggleAnimation(!1), t[0].addEventListener("touchmove", this.touchHendler.bind(this), {
                passive: !1
            }), t.on("touchend.range", () => {
                this.afterRunnerReleased(), t[0].removeEventListener("touchmove", this.touchHendler), t.off("touchend.range")
            })
            ...
            if (1 !== e.touches.length) return !1;
            e.stopPropagation(), this.updateBarWidth(), this.activeRunner = "start", this.$startRunner.addClass("upper-runner"), this.$endRunner.removeClass("upper-runner"), e.stopPropagation(), this.startWatchingEvents(e.touches[0].pageX - this.$startRunner.offset().left), this.toggleAnimation(!1), t[0].addEventListener("touchmove", this.touchHendler.bind(this), {
                passive: !1
            }), t.on("touchend.range", () => {
                this.afterRunnerReleased(), t[0].removeEventListener("touchmove", this.touchHendler), t.off("touchend.range")
            })
            ...
            $(e).on("click", () => {
                if (this.updateBarWidth(), this.isDouble) {
                    const t = this.startEdge < this.endEdge ? 1 : -1,
                        s = (this.startValue + this.endValue) / 2,
                        n = +$(e).data("value");
    ...
    handleKeydown(t, e) {
        if (this.movingInterval && (clearInterval(this.movingInterval), this.movingInterval = !1), this.movingDebounceTimeout && (clearTimeout(this.movingDebounceTimeout), this.movingDebounceTimeout = !1), [37, 38, 39, 40].includes(t.keyCode)) {
            const s = t.shiftKey ? 10 : 1,
                n = "start" === this.activeRunner ? "startValue" : "endValue";
...
flexbe_cli.components.classes.VideoBackground = class {
    ...
    initVideo() {
        ...
        }), "vimeo" === this.video.type ? this.createVimeo() : "youtube" === this.video.type ? this.createYoutube() : this.createMP4(), document.addEventListener("visibilitychange", () => {
    ...
    createYoutube() {
        ...
        if (window.YT || window.onYouTubeIframeAPIReady)
            if (window.onYouTubeIframeAPIReady) window.youtubeBGQuae.push(() => {
                const i = $("<div></div>");
    ...
    createMP4() {
        this.$videoElement = $(`<video src="${this.video.url}" controlslist="nodownload" loop="1" muted="1" autoplay="1" playsinline="1"></video>`), this.insertVideo(), this.$videoElement[0].oncanplay = () => {
            ...
            this.video.size = {
                res: this.$videoElement.width() / this.$videoElement.height()
            }, this.resize()
        })
    }
    getVimeoResolution() {
    ...
    youtubeGetResolution() {
        const e = this.$videoElement.attr("width"),
    ...
    resize() {
        if (this.video && this.video.size)
            if (this.$videoElement.width(this.$videoElement.height() * this.video.size.res), this.fixed) {
                const e = {
                    height: window.innerHeight,
                    width: window.innerWidth
                };
                this.isDesktop || (e.height += 60, e.width += 60), e.res = e.width / e.height, this.video.size.res > e.res ? (this.$videoElement.css({
                    height: `${e.height}px`
                }), this.$videoElement.css({
                    width: `${e.height*this.video.size.res}px`
                })) : (this.$videoElement.css({
                    width: `${e.width}px`
                }), this.$videoElement.css({
                    height: `${e.width/this.video.size.res}px`
                }))
            } else {
                ...
                if (this.video.size.res > this.sectionSize.res || e < this.video.size.res && this.parallax) {
                    ...
                    this.$videoElement.css({
                        ...
                        height: `${e/this.video.size.res}px`
                    })
                }
...
! function() {
    ...
    flexbe_cli.components.classes.selectInput = class {
        constructor(t) {
            this.opts = t, this.config = Object.assign({}, e, t.config), this.element = t.element, this.$select = $(this.element), this.isNativeSelect = this.$select.is("select"), this.blurTimeOut = !1, this.focused = !1, this.active = !1, this.createSelect()
        }
        createSelect() {
            this.$customSelect = $(`\n                <div class="dropdown-container ${this.config.selectClass}">\n                    <div tabindex="0" class="dropdown-select">\n                        <span class="dropdown-select__content selected"></span>\n\n                        <span class="arrow">\n                            <svg viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg">\n                                <path fill="currentColor" d="M 1.4 6.99441e-15L 0 1.34043L 5 6L 10 1.34043L 8.6 0L 5 3.34998L 1.4 6.99441e-15Z"/>\n                            </svg>\n                        </span>\n                    </div>\n                </div>\n            `), this.$customSelect__content = this.$customSelect.find(".dropdown-select__content"), this.$select.after(this.$customSelect), this.syncSelect(), flexbe_cli.run.is_screen_desktop_all || flexbe_cli.run.is_screen_tablet_all || !flexbe_cli.responsive ? (this.$customSelect.off("click.selected").on("click.selected", ".dropdown-select", () => {
                this.active ? this.collapse() : this.activate()
            ...
            }), this.$customSelect.off("blur.selectBlur").on("blur.selectBlur", ".dropdown-select", () => {
                this.focused = !1, this.blurTimeOut = setTimeout(() => {
                    this.$listWrapper && this.collapse()
                }, 200)
            }), this.isNativeSelect && this.$select.off("change.changeSelect").on("change.changeSelect", e => {
                const t = this.$listWrapper.find(".dropdown-select-ul li"),
                    s = e.currentTarget.value;
                t.removeClass(this.config.selectedClass), t.filter((e, t) => t.getAttribute(this.config.attrValue) === s).addClass(this.config.selectedClass), this.$customSelect__content.text(s), "function" == typeof this.opts.onChange && this.opts.onChange(e)
            }), this.$customSelect.off("keydown.selectKeydown").on("keydown.selectKeydown", ".dropdown-select", e => {
                if (this.focused && [13, 27, 32, 38, 40].includes(e.keyCode)) {
                    e.preventDefault();
                    const t = this.$list.find(`.option-e.${this.config.selectedClass}`).filter(e => !$(e).attr("disabled"));
                    if (40 === e.keyCode) e.preventDefault(), this.select(t.next(), !1), this.scrollToSelected();
                    else if (38 === e.keyCode) e.preventDefault(), this.select(t.prev(), !1), this.scrollToSelected();
                    else if (this.active || 32 !== e.keyCode) {
                        if (this.active && [13, 27, 32].includes(e.keyCode)) return e.preventDefault(), this.collapse(), !1
                    } else e.preventDefault(), this.activate()
                }
            })) : this.$select.off("change.selected").on("change.selected", e => {
                const t = e.target.value;
                this.$customSelect__content.text(t)
            })
        }
        syncSelect() {
            const e = this.$select.children(this.config.optionSelector).filter((e, t) => {
                var s;
                return (null != (s = t.selected) ? s : $(t).attr("selected")) || $(t).hasClass(this.config.selectedClass)
            }).eq(0).html().trim() || "—";
            this.$customSelect__content.html(e)
        }
        createList() {
            const e = this.$select.children(this.config.optionSelector);
            this.$listWrapper = $(`\n                <div class="select-container-in-body">\n                    <div class="overlay"></div>\n                    <ul class="dropdown-select-ul scrollable ${this.config.dropdownClass}"></ul>\n                </div>\n            `), this.$list = this.$listWrapper.find(".dropdown-select-ul"), e.each((e, t) => {
                var s, l, i;
                const c = $(t),
                    o = (null != (s = t.selected) ? s : c.attr("selected")) || c.hasClass(this.config.selectedClass),
                    n = (null != (l = t.disabled) ? l : c.attr("disabled")) || c.hasClass("disabled"),
                    a = (null != (i = t.locked) ? i : c.attr("locked")) || c.hasClass("locked"),
                    r = this.isNativeSelect ? c.val() : c.attr(this.config.attrValue),
                    h = c.html().trim() || "—",
                    d = $('<li class="option-e"></li>');
                o && d.addClass(this.config.selectedClass), n && d.attr("disabled", "disabled"), a && d.attr("locked", "locked"), d.attr(this.config.attrValue, r), d.html(h), this.$list.append(d)
            })
        }
        select(e, t) {
            if (!e[0]) return;
            if (e.attr("disabled")) return void clearTimeout(this.blurTimeOut);
            const s = e.attr(this.config.attrValue);
            if (e.siblings("li").removeClass(this.config.selectedClass), e.addClass(this.config.selectedClass), this.isNativeSelect) this.$select.val(s);
            else {
                const e = this.$select.children(this.config.optionSelector);
                e.removeAttr("selected").removeClass(this.config.selectedClass), e.filter(`[${this.config.attrValue}=${s}]`).addClass(this.config.selectedClass).attr("selected", "selected")
            }
            this.syncSelect(), t && this.collapse()
        }
        scrollToSelected() {
            const e = this.$list[0].offsetHeight;
            if (this.$list[0].scrollHeight <= e) return !1;
            this.$list.children(".option-e").find(`.${this.config.selectedClass}`).scrollIntoView()
        }
        collapse() {
            this.active = !1, this.$listWrapper.removeClass("active"), clearTimeout(this.blurTimeOut), this.$listWrapper.detach(), "function" == typeof this.opts.onCollapse && this.opts.onCollapse()
        }
        activate() {
            if (this.active) return !1;
            this.active = !0, this.createList();
            const e = {
                left: this.$customSelect.offset().left,
                top: this.$customSelect.offset().top,
                width: this.$customSelect.width()
            };
            "under" === this.config.position && (e.top = e.top + this.$customSelect.height() + 10), this.$listWrapper.off("click.closeSelect").on("click.closeSelect", ".overlay", e => {
                this.collapse(), document.elementFromPoint(e.clientX, e.clientY).focus()
            }), this.$listWrapper.off("click.selectLi").on("click.selectLi", ".dropdown-select-ul li", e => {
                const t = $(e.currentTarget);
                this.select(t, !0), "function" == typeof this.opts.onSelect && this.opts.onSelect(e)
            }), this.$listWrapper.off("mousewheel.selectUl").on("mousewheel.selectUl", ".dropdown-select-ul", e => {
                const t = e.currentTarget.scrollHeight,
                ...
                top: `${e.top}px`,
                width: `${e.width}px`
            }), this.$listWrapper.addClass("active"), this.scrollToSelected(), "function" == typeof this.opts.onActivate && this.opts.onActivate()
        }
    }
}();
flexbe_cli.components.classes.tabsController = class {
    constructor(t) {
        this.selectedTab = location.hash.replace(/^#tab/, ""), this.interacted = !1, this.opts = t, this.$area = t.$area, this.dataAttr = t.dataAttr, this.classContainer = t.classContainer, this.id = t.id
    }
    initTabs() {
        if (this.$mainContainer = this.$area.find(this.classContainer), this.$tabsContainer = this.$area.find(".container-tabs"), this.$tabsList = this.$area.find('[role="tablist"]'), this.$swiperHelper = this.$area.find(".tab-swiper-helper"), !this.$tabsList.length) return void(this.tabInited = !1);
        this.tabInited = !0, this.$tabs = this.$tabsList.find('[role="tab"]'), this.$sections = this.$mainContainer.find('[role="tabpanel"]');
        let t = this.selectedTab && this.$tabs.filter(`[${this.dataAttr}="${this.selectedTab}"]`);
        if (t && t.length || (t = this.$tabs.eq(0)), this.normalizeLines(), this.selectTab(t.attr(`${this.dataAttr}`), {
                force: !0
            }), setTimeout(() => {
                this.$mainContainer.addClass("main-area--tabs-inited")
            }, 150), this.$tabsContainer.on("click", ".tab", t => {
                const s = $(t.currentTarget).closest(`[${this.dataAttr}]`).attr(`${this.dataAttr}`);
                s && (this.selectTab(s), this.setHash())
            }), this.$area.on("bringIntoView", t => {
                const s = $(t.target).closest(`[${this.dataAttr}]`).attr(`${this.dataAttr}`);
                this.selectTab(s)
            }), this.$tabsList.on(`touchstart.${this.id}`, () => {
                this.interacted = !0, this.destroySwipeAnimation()
            }), flexbe_cli.is_admin) {
            let t;
            this.$tabsContainer.on("mouseenter", ".tab", s => {
                clearTimeout(t), 1 === s.buttons && (t = setTimeout(() => {
                    const t = $(s.target).closest(`[${this.dataAttr}]`).attr(`${this.dataAttr}`);
                    this.selectTab(t), this.setHash()
                }, 700))
            }), this.$tabsContainer.on("mouseleave", ".tab", () => {
                clearTimeout(t)
            })
        }
    }
    tabListOnScreen() {
        if (this.$tabsList && this.$tabsList.length) {
            const {
                top: t,
                height: s
            } = this.$tabsList[0].getBoundingClientRect();
            return t > 0 && t + s < flexbe_cli.resize.viewportHeight
        }
        return !1
    }
    swipeAnimationController() {
        const t = this.$tabsList[0] && this.$tabsList[0].scrollWidth > this.$tabsList[0].clientWidth,
            s = this.tabListOnScreen();
        t && s ? this.initSwiperAnimation() : s || this.destroySwipeAnimation()
    }
    initSwiperAnimation() {
        this.$swiperHelper.hasClass("show") || this.interacted || this.$swiperHelper.addClass("show")
    }
    destroySwipeAnimation() {
        this.$swiperHelper.hasClass("show") && this.$swiperHelper.removeClass("show")
    }
    selectTab(t, {
        force: s
    } = {}) {
        if (!this.tabInited || !t) return;
        if (!s && this.selectedTab === t) return;
        this.selectedTab = t;
        const i = this.$tabs.filter(`[${this.dataAttr}="${this.selectedTab}"]`),
            e = this.$sections.filter(`[${this.dataAttr}="${this.selectedTab}"]`),
            a = this.$sections.filter(".active"),
            n = a[0] && a[0].offsetTop;
        this.scrollToTab(i), this.$tabs.removeClass("active").attr("aria-selected", !1).attr("tabindex", -1), i.addClass("active").attr("aria-selected", !0).attr("tabindex", 0), this.$sections.removeClass("active").prop("hidden", !0), e.addClass("active").prop("hidden", !1);
        const r = e[0] && e[0].offsetTop;
        if (this.$activeTab = i, this.$activeSection = e, "function" == typeof this.opts.onSelectTab && this.opts.onSelectTab(), !flexbe_cli.run.is_mobile && null != n && null != r && Math.abs(n - r) > 0 && "undefined" != typeof anime) {
            const t = this.$mainContainer,
                s = n - r;
            t.css("will-change", "transform"), anime({
                targets: t[0],
                translateY: [s, 0],
                duration: 250,
                easing: "easeOutCubic",
    ...
    normalizeLines() {
        if (!this.tabInited) return;
        let t;
        const s = this.$tabs;
        this.$tabsList.find(".tab-spacer").remove(), s.removeClass("first-in-line last-in-line"), s.first().addClass("first-in-line"), s.last().addClass("last-in-line"), s.each((s, i) => {
            t && t.offsetTop !== i.offsetTop && ($(i).addClass("first-in-line"), $(t).addClass("last-in-line"), $(t).after('<span class="tab-spacer"></span>')), t = i
        })
    }
    scrollToTab(t) {
        if (!this.tabInited) return;
        const s = this.$tabsList,
            i = s[0].scrollWidth;
        if (i > s[0].offsetWidth) {
            const e = t[0].offsetLeft,
                a = t[0].getBoundingClientRect(),
                n = flexbe_cli.resize.viewportWidth;
            let r;
            a.width > n || a.left < 20 ? r = e - 20 : a.right > n - 20 && (r = e - (n - 20 - a.width)), null != r && (r = Math.max(0, Math.min(i - n, r)), s.animate({
                scrollLeft: r
            }, {
                duration: 250
            }))
    ...
    setHash() {
        const t = this.$activeSection.find("._anchor").eq(0).attr("name");
...
! function() {
    function t(t, e, i, s) {
        const a = $(t),
            n = e ? `[data-component="${e}"]` : "[data-component]";
    ...
    class i {
        ...
        setActive(t, i) {
            ...
            if (t = Math.max(Math.min(t, s.length - 1), 0), l = l && l.length ? l : s.map(t => {
                    ...
                    state: i
                }) => t + (e(i) ? 1 : 0), 0)) !== this.visible) o = Math.min(t + this.visible - 1, s.length - 1), n = Math.max(o - this.visible + 1, 0), r = l.map(({
                target: t,
                state: e
            }, i) => ({
                target: t,
                ...
                r = l.map(({
                    ...
                    const r = l[a - i];
                    return "normal" === (s = r && r.state && e(r.state) ? "normal" : "hidden") && (void 0 === n && (n = a), o = a), {
                        target: t,
                        state: s
                    }
                })
            }
            return r[t].state = "active", r[n - 1] && (r[n - 1].state = "next"), r[n - 2] && (r[n - 2].state = "more"), r[o + 1] && (r[o + 1].state = "next"), r[o + 2] && (r[o + 2].state = "more"), s.forEach((t, e) => {
                t.setAttribute("data-state", r[e].state)
            }), this.active = t, this.oldMap = r, t
        }
    }
    class s {
        constructor(t, e) {
        ...
        bindEvents() {
            ...
            "function" == typeof i.onClick && s.off(".bpc").on("click.bpc", t, t => {
                const e = $(t.currentTarget),
                    s = +e.siblings('[data-state="active"]').attr("data-index"),
    ...
    class a extends BaseComponent {
        constructor(...t) {
            ...
            this.require = ["/_s/lib/swiper/swiper.v5.js?538"], this.is = "slider", this.swiper = null, this.initialSlide = 0, this.sliderEl = e.querySelector(".swiper-container"), this.paginationEl = e.querySelector(".slider-pagination"), this.prevEl = e.querySelector('.slider-prev, [data-direction="prev"]'), this.nextEl = e.querySelector('.slider-next, [data-direction="next"]');
        ...
        onView({
            ...
            this.isLoaded && (t && !this.swiper && this.initSwiper(), this.swiper && this.toggleAutoplay({
                state: t
            }))
        }
        onScreen({
        ...
        initSwiper() {
            ...
            const {
                ...
                paginationType: f,
                effect: m
            } = e, b = this.owner.closest(".swiper-inited"), v = {
                prevEl: h,
                nextEl: p
            }, w = {
                el: d,
                ...
                delay: 1e3 * e.autoplay,
                stopOnLastSlide: !g,
                disableOnInteraction: !1
            };
            let y, S = this.initialSlide;
            if (flexbe_cli.is_admin) {
            ...
            this.swiper = C, C.on("init", () => {
                if (this.setComponentSize(), this.setSliderClasses(), $(h).add(p).removeClass("disabled"), "thumbs" === f && $(d).removeClass("disabled"), g) {
                    $(".swiper-slide-duplicate", a).attr("data-cloned", !0), flexbe_cli.components.initComponents({
                        core: n
                    })
                }
                const e = C.slides[C.previousIndex],
                    i = C.slides[C.activeIndex];
                setTimeout(() => {
            ...
            g && C.on("slideChangeTransitionEnd", () => {
                ...
                $(r).addClass("slider-in-animation")
            }), C.on("slideChangeTransitionEnd touchEnd", () => {
                $(r).removeClass("slider-in-animation")
                ...
                if (!A)
                    if (this.bulletsPagination) this.bulletsPagination.setActive(C.realIndex);
                    else if (this.loopPagination) {
                    const t = C.previousIndex < C.activeIndex ? "next" : "prev";
                    this.loopPagination.setActive(t)
                }
            }), this.$component.on("preventSliderAutoplay", (t, {
                state: e = !0
            }) => {
                this.preventAutoplay = !!e, this.preventAutoplay && this.toggleAutoplay({
                    state: !1
                })
            }), C.init(), this.toggleAutoplay({
                state: this.inView
            })
        }
        loadImages() {
        ...
        slideTo(t, e = !0) {
            this.swiper ? void 0 !== this.swiper.realIndex && this.swiper.realIndex !== t && (e ? this.swiper.slideToLoop(t) : this.swiper.slideTo(t)) : this.initialSlide = t
        }
        setSliderClasses() {
            if (!this.swiper) return;
            const {
                effect: t
            } = this.swiper.params, e = $(this.sliderEl);
        ...
        setComponentSize() {
            const t = this.$component.find(".swiper-container");
            if (!t.length) return;
            const e = t[0];
            e.style.width = "";
            const i = e.getBoundingClientRect().width,
                s = e.offsetWidth;
            if (i % 1 > 0 && Math.abs(s - i) < 2 && (e.style.width = `${Math.round(i)}px`, this.swiper && this.swiper.update()), "thumbs" === this.options.paginationType) {
                const t = $(this.paginationEl).find(".thumbs-slider"),
                    e = t.find(".thumb-item"),
                    i = 4,
                    s = e.length,
                ...
                const n = t[0].offsetWidth,
                    o = e[0].offsetWidth;
                let l = Math.max(i, Math.round(n / o));
                s >= i && (s === l + 1 || s === l - 1) ? l = s : !a || a !== l + 1 && a !== l - 1 || (l = a);
                const r = Math.round(n / l) * l;
                n !== r && t.css("width", `${r}px`), t.toggleClass("is-filled", s >= l), this.thumbsSwiper && (this.thumbsSwiper.params.slidesPerView = l, this.thumbsSwiper.update())
            }
        }
    }
...
! function() {
    const t = document,
        e = "[data-action-target]",
        a = "a[href], [data-action]";
    let i;
    class o {
        ...
        actionLink(t) {
            const e = t.currentTarget,
                a = e.hasAttribute("href") ? e.getAttribute("href") : "",
                i = "_blank" === e.getAttribute("target") || t.metaKey || t.ctrlKey,
                o = e.hasAttribute("download");
        ...
        actionQuiz(t) {
            ...
            flexbe_cli.events.emit("quiz_command", {
                command: "start",
                id: e
            })
        }
        ...
        reachGoals(t) {
            const e = $(t.currentTarget),
                ...
                o = flexbe_cli.stat.getGoal(a, i),
                n = e.attr("data-goal"),
                c = e.attr("data-html-goal");
...
! function() {
    ...
    class o extends e {
        constructor(...e) {
            super(...e);
            const o = flexbe_cli.components.classes.map.getLocaleCode({
                    provider: "yandex"
                }) || "ru_RU",
        ...
        dispatchEvents() {
            ...
            o && (this.$component.on("selectMark", (t, s) => {
                ...
                t = !0, this.$component.trigger("preventSliderMove", {
                    state: !0
                }), this.$component.trigger("preventSliderAutoplay", {
                    state: !0
                })
            }), $(window).on("mouseup", () => {
                t && (this.$component.trigger("preventSliderMove", {
                    state: !1
                }), this.$component.trigger("preventSliderAutoplay", {
                    state: !1
                }), t = !1)
    ...
    class t extends e {
        constructor(...e) {
            ...
            const o = flexbe_cli.vars._group.googleMapsKey,
                t = flexbe_cli.components.classes.map.getLocaleCode({
                    provider: "google"
                }) || "ru";
            ...
            o && e.places.forEach((e, t) => {
                const s = `<svg width="32" height="48" viewBox="0 0 24 32" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.36 0 0 5.36 0 12c0 8 12 20 12 20s12-12 12-20c0-6.64-5.36-12-12-12zm0 8a4 4 0 0 1 4 4c0 2.22-1.78 4-4 4a4 4 0 0 1-4-4c0-2.2 1.8-4 4-4z" fill="${e.color||"#222"}" fill-rule="evenodd"/></svg>`,
                    a = new google.maps.Marker({
                        ...
                        icon: {
                            url: `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(s)}`
                        }
                    });
        ...
        selectMark(e, o = !1) {
            ...
            const n = a[e];
            let i = "";
            n.name && (i += `<div style="margin-bottom: 3px;"><strong>${n.name}</strong></div>`), n.address && (i += `<div>${n.address}</div>`), n._info = new google.maps.InfoWindow({
                content: i
            }), n._info.open(s, n._mark), o && s.panTo({
                lat: n.coords[0],
                lng: n.coords[1]
    ...
    }, flexbe_cli.components.classes.map.getLocaleCode = ({
        lang: e,
        provider: o
    }) => {
        const t = e || flexbe_cli.locale.language,
            s = {
                yandex: {
                    ru: "ru_RU",
                    by: "ru_RU",
...
function _extends() {
    ...
    class e {
        ...
        static getRecaptchaSiteKey() {
            const t = this.getRecaptchaSettings(),
                e = t.env || {};
            return t.visible ? e.RECAPTCHA_VISIBLE_SITE_KEY : e.RECAPTCHA_INVISIBLE_SITE_KEY
        }
        constructor(t, i = e.getRecaptchaSettings()) {
            this.id = t.id, this.options = t, this.$form = t.$form, this.enabled = i.enabled, this.isOptional = i.ttl > 0, this.isVisible = i.visible, this.isInvisible = !i.visible, this.inModal = !(!this.isVisible || !this.isOptional && !t.inModal), this._widgetId = null, this._token = null
        }
        get loaded() {
        ...
        init() {
            ...
            this._inited = !0;
            const t = this.$form.find(".g-recaptcha");
            t[0] && this.render(t[0])
        }
        getToken() {
            return this._token
        ...
        render(t) {
            ...
            grecaptcha.ready(() => {
                try {
                    this._widgetId = grecaptcha.render(t, a)
                } catch (t) {}
        ...
        runModalCaptcha() {
            ...
            if (!this._modal) {
                ...
                flexbe_cli.modal.$list.append(e), this._modal = flexbe_cli.entity.initArea(e[0])
            }
    ...
    class i extends BaseComponent {
        static getDefaultMask(e) {
            const i = String(e).toLowerCase(),
                a = flexbe_cli.locale.country;
            let u = t[i] && t[i][a];
            return u && "string" == typeof u && (u = [u]), Object.assign([], u)
        }
        static initMask(t) {
            ...
            const e = {
                    ...
                    definitions: "tel" === t.getAttribute("type") ? {
                        "*": /\d/,
                        "#": /\d/
                    } : {
                        "#": /\d/,
            ...
            let a = t.getAttribute("data-mask");
            a = a && !/[ ()*{}#@]/.test(a) ? this.getDefaultMask(a) : [a];
            try {
                if (a = a.filter(t => /[ ()*_{}#@]/.test(t)), a = a.map(t => t.replace(/0/g, "\\0")), 0 === a.length) throw {
                    message: "Mask is empty"
                };
                a = 1 === a.length ? String(a[0]) : a.map(t => Object.assign({}, e, {
                    mask: t
                }));
                const u = new IMask(t, Object.assign({}, e, {
                        mask: a,
                        dispatch: (t, e) => {
                            const i = e.compiledMasks;
                            if (1 === i.length) return i[0];
                            const a = (e.value + t).replace(/\W/g, "");
                            return i.find(t => {
                    ...
                    s = () => {
                        u.masked.isComplete || !i && !u.value ? t.setAttribute("data-mask-complete", !0) : t.removeAttribute("data-mask-complete"), t.setAttribute("value", u.value)
                    };
                t.value && s(), u.on("accept", s), t._mask = u
            } catch (e) {
                return e instanceof Error && console.warn("MASK ERROR:", {
                    masks: a,
                    errorMessage: e.message
                }), t.removeAttribute("data-mask"), !1
            }
        }
        static initCalendar(t, e) {
            const i = $(t),
                a = i.closest("[data-type]").attr("data-type"),
                u = i.attr("data-date-range") || "any",
                s = i.attr("data-date-work-days") || "0,1,2,3,4,5,6";
            ...
            let o = new Date((new Date).getFullYear() - 100, 0, 1),
                r = new Date(n, 11, 31);
            "datetime" !== a && "future" !== u || (o = new Date), "date" === a && "past" === u && (r = new Date);
            const l = {
                type: a,
                lowerLimit: o,
                upperLimit: r,
                ...
                showDateSelector: "date" === a && "future" !== u,
                constraintByEl: e
            };
            if (s && (l.workDays = s.split(",")), "datetime" === a) {
                ...
                l.workTime = {
                    interval: t,
                    start: {
                        hour: +e.substring(0, 2),
                        minute: +e.substring(3, 5)
                    },
                    finish: {
                        hour: +a.substring(0, 2),
                        minute: +a.substring(3, 5)
                    }
                }
            }
            i.calendar(l)
        ...
        constructor(...t) {
            super(...t), this.is = "form", this.id = this.core.id, this.eventId = `.${this.id}`, this.$form = this.$component.find("form"), this.$fields = this.$form.find(".form-fields"), this.action = this.$form.find('input[name="action"]').val(), this.isInline = this.$component.attr("data-inline") ? 1 : 0, this.inCart = this.$component.closest(".w_cart").length > 0, this.inModal = this.$component.closest(".m_modal").length > 0, this.busy = !1;
            const i = e.getRecaptchaSettings();
            i.enabled && (this.captcha = new e({
                id: this.id,
                $form: this.$component,
        ...
        onOpen(t = {}) {
            ...
            !flexbe_cli.run.is_screen_mobile_all && !flexbe_cli.is_admin && flexbe_cli.resize.viewportHeight > e + 100 && this.$component.find(".form-field").eq(0).find("input, textarea").eq(0).focus(), t && t.data && this.setData(t.data)
        }
        onResize() {
        ...
        bindEvents() {
            const t = this.$fields.find(".form-field-text__input, .form-field-text__textarea, .form-field-checkbox__input"),
                e = this.$form.closest(".scroller");
            t.on(`keydown${this.eventId}`, t => {
                const e = t.currentTarget,
                    i = e.getAttribute("data-check"),
                    a = t.key || "",
                    u = t.ctrlKey || t.metaKey;
                return !("phone" === i && !e._mask && !u && 1 === a.length && /[^\d ()+-]/.test(a)) && (("email" !== i || !/[\s,]/.test(a)) && void 0)
            }), t.on(`input${this.eventId} change${this.eventId}`, t => {
                const e = t.currentTarget,
                    i = $(e);
                i.attr("value", e.value), i.closest(".form-field").removeClass("is_error")
                ...
                this.$calendars.toArray().forEach(t => {
                    const i = $(t).data("calendar");
                    e.on(`scroll${this.eventId}`, () => {
                        i.main.toPosition()
                    })
                })
            }, 150), this.$form.off("submit").on(`submit${this.eventId}`, t => {
                return (async () => {
        ...
        //             value: e
        //         })
        //     }), this.lastItems = t || [], this.addFields(u)
        // }
        // sendForm() {
        ...
        //     if (e.append("is_ajax", "true"), e.append("p_id", flexbe_cli.p_id), e.append("jsform", parseInt(448312, 10)), "undefined" != typeof flexbeAPI && void 0 !== flexbeAPI.customLeadData && e.append("customLeadData", JSON.stringify(flexbeAPI.customLeadData)), flexbe_cli.stat.u_id && e.append("f_uid", flexbe_cli.stat.u_id), flexbe_cli.run.is_OSX && "function" == typeof e.entries)
        //         for (const t of e.entries()) {
        //             const [i, a] = t;
        //             "object" == typeof a && a instanceof File && 0 === a.size && "function" == typeof e.delete && e.delete(i)
        //         }
        //     e.append("f_ab", JSON.stringify(flexbe_cli.stat.AB.getCookie())), "function" == typeof e.delete && e.delete("g-recaptcha-response"), t && e.append("captcha-token", t);
        //     const i = {
        ...
        //         const i = 0 == e.status,
        //             a = i && e.captcha;
        //         if (this.captcha && a) t ? this.captchaAddError() : this.captcha.inModal ? this.captchaModalRun() : this.captcha.isInvisible && (this.captcha.isOptional = !1, this.captchaInvisibleRun());
        //         else {
        ...
        // }
        // clearSubmitting(t = !1) {
        //     this.busy && (this.$component.removeClass("submitting"), t ? (this.$component.addClass("success submit-ok"), setTimeout(() => {
        //         this.busy = !1, this.$component.removeClass("success submit-ok")
        //     }, 1e3)) : this.busy = !1)
        // }
        // showDone() {
        //     if ("function" == typeof this.afterSent && this.afterSent(), Array.isArray(this.lastItems) && this.lastItems.forEach(t => {
        ...
        //         const t = this.$form.find('input[name="action_redirect"]');
        //         let e;
        //         t && t.length && (e = t.val()), e && setTimeout(() => {
        //             flexbe_cli.helpers.gotoLink(e)
        //         }, 500)
        //     } else {
        //         let t = this.$component.find("[data-modal-id]").attr("data-modal-id");
        //         if (!flexbe_cli.modal.find(t)) {
        //             const e = String(this.id),
        //                 i = e && e.split("_")[0];
        //             if ("done" === t && $(document).find(`.m_${e}`).length) return void flexbe_cli.events.emit("ui_modal_close", {
        //                 id: e
        //             });
        //             t = `${i}_${t}`
        //         }
        ...
        //         i = t.filter("select"),
        //         a = t.filter(".form-field-range__input");
        //     i.each((t, e) => {
        //         const i = e.querySelector("option"),
        //             a = i && i.value || "";
        //         e.value !== a && (e.value = a, e.dispatchEvent(new Event("change", {
        //             bubbles: !0,
        //             cancelable: !0
        //         })))
        //     }), a.each((t, e) => {
        ...
        //         if (["radio", "checkbox"].includes(e.type)) i ? e.setAttribute("checked", !0) : e.removeAttribute("checked"), e.checked = i;
        //         else {
        ...
        //         let u;
        //         const s = $(a),
        //             n = s.find("input, textarea, select").not('[type="hidden"]')[0],
        //             o = s.attr("data-type");
        //         if (!n && "captcha" !== o) return;
        //         const r = "checkbox" === n.type ? n.checked : n.value;
        //         if ("captcha" === o) {
        //             if (!this.captcha) return;
        //             u = !this.captcha.getToken() && flexbe_cli.locale.tr("form::captcha_not_checked")
        //         } else u = this.checkField(n);
        //         if (s.removeClass("is_error"), u) {
        //             const e = s.attr("data-type"),
        //                 i = s.find(".error");
        //             s.outerWidth(), s.addClass("is_error"), i.length && (i.attr("title", u), i.find(".error-text").text(u)), "checkbox" === e && s.find(".form-field-checkbox__box").attr("title", u), t = !1
        //         }
        //         e && r && (e = !1)
        //     }), this.$fields.removeClass("all-fields-empty"), this.$fields.removeClass("has-error"), this.$fields.outerWidth(), t || this.$fields.addClass("has-error"), e && (this.$fields.toggleClass("all-fields-empty", e), 4 === flexbe_cli.theme_id && (t = !1)), t
        // }
        // captchaAddError(t) {
        ...
        // }
        // fileInput() {
        //     this.$component.on(`change${this.eventId}`, ".file-input", t => {
        //         const e = $(t.currentTarget),
        //             i = e.parents(".file-input-outer"),
        //             a = e.val(),
        //             u = t.currentTarget.files.length;
        //         if (i.addClass("active"), e.parents(".form-field").removeClass("is_error"), 1 === u && i.find(".form-field-file--file-name").text(a), u > 1) {
        //             const t = u % 100,
        //                 e = u % 10,
        //                 a = Math.floor(t / 10);
        //             let s;
        //             s = 1 === e && 11 !== t ? "form.filesMult" : e > 1 && e < 5 && 1 !== a ? "form.filesMult1" : "form.filesMult2", i.find(".form-field-file--file-name").text(`${u} ${flexbe_cli.locale.tr(s)}`)
        //         }
        //         0 === u && i.removeClass("active")
        //     }), this.$component.on(`click${this.eventId}`, ".clear-files", t => {
        //         const e = $(t.currentTarget).parents(".file-input-outer");
        ...
        //             s = +a.attr("rows") || 0,
        //             n = parseInt(u.paddingTop, 10) + parseInt(u.paddingBottom, 10),
        //             o = parseInt(u.lineHeight, 10);
        //         a.removeAttr("data-autoresize"), a.off("keyup input").on("keyup input", (function(t) {
        //             const e = t.currentTarget;
        //             e.style.height = `${e.scrollHeight+i}px`
        //         })), a.css("minHeight", `${n+o*s}px`)
        //     })
        // }
        customSelect() {
            ...
            const t = this.$component.find("select.atom-custom-select"),
                e = {
                    dropdownClass: this.$component.hasClass("style-underlined") ? "sharp size--medium " : "size--medium "
                };
            t.each((t, i) => {
                const a = $(i).closest('[data-type="select"]');
                new flexbe_cli.components.classes.selectInput({
                    element: i,
                    config: e,
                    onCollapse: () => {
                    ...
                    onActivate: () => {
                        a.addClass("active"), a.siblings('[data-type="select"]').removeClass("active")
                    }
                })
            })
        }
        deliveryField() {
            ...
            const t = this.$delivery,
                e = flexbe_cli.widget.cart,
                i = flexbe_cli.widget.cart.delivery,
                a = t.find(".form-field-delivery-item"),
                u = t.find(".form-field-delivery-fields"),
                s = () => {
                    const t = i.activeMethod;
                    if (!t) return;
                    const e = a.filter(`[data-delivery="${t.id}"]`),
                        s = u.filter(`[data-delivery="${t.id}"]`);
                    a.removeClass("form-field-delivery-item--active"), e.addClass("form-field-delivery-item--active"), u.removeClass("form-field-delivery-fields--active"), s.addClass("form-field-delivery-fields--active"), u.find("input, textarea, select").prop("disabled", !0), s.find("input, textarea, select").prop("disabled", !1)
                },
                n = () => {
                    a.each((t, e) => {
                        const a = e.getAttribute("data-delivery"),
                            u = $(e).find(".item-price"),
                            s = $(e).find(".delimiter"),
                            n = $(e).find(".min-total"),
                            o = i.getPrice(a),
                            r = `${flexbe_cli.locale.tr("form.min_total_tip")} ${o.minTotalFormatted}`;
                        o.isNotFree || o.untilFree && o.useNotFixTotal ? (u.text(""), s.text("")) : (u.text(o.currentFormatted), s.text("–")), n.text(flexbe_cli.locale.tr(r))
                    })
                };
            s(), n(), t.on("change", ".form-field-delivery-item input", t => {
        ...
        checkField(t) {
            ...
            const e = t.type,
                i = "checkbox" === e ? t.checked : "file" === e ? t.files : t.value,
                a = t.getAttribute("data-required") || !1,
                u = t.getAttribute("data-check") || !1;
            let s = !(!a || i) && "form.required";
            if (t._mask && t.getAttribute("data-mask") || !1) {
                !a && !i || t.getAttribute("data-mask-complete") || (s = "tel" === e && i ? "form.phone" : "text" === e && i ? "form.text" : "form.required")
            } else if (u)
                if ("date" === u || "datetime" === u) {
                    const e = $(t).data("calendar"),
                        i = e && e.input.checkError();
                    i && (s = i)
                } else if (i.length && "email" === e) {
                /^(([^\s"(),.:;<>@[\\\]]+(\.[^\s"(),.:;<>@[\\\]]+)*)|(".+"))@((\[(?:\d{1,3}\.){3}\d{1,3}])|(([-_\dA-Za-zЁА-яё]+\.)+[A-Za-zЁА-яё]{2,}))$/.test(i) || (s = "form.email")
            } else if (i.length && "tel" == e)
                if (/[^\d\s()+-]/.test(i)) s = "form.digits";
                else {
                    i.replace(/\D/g, "").length < 5 && (s = "form.minlength")
                }
            else "file" === e && (s = !(!a || i.length) && "form.required");
            return s = s && flexbe_cli.locale.tr(s) || !1, s
        }
        inputRange() {
            this.$form.find(".form-field-range").each((t, e) => new flexbe_cli.components.classes.rangeInput($(e)))
        }
        inputMask() {
            return "undefined" != typeof IMask && (this.hasMaskedField = !1, this.$masked.each((t, e) => {
                ...
                const i = !!e.getAttribute("data-placeholder"),
                    a = e._mask;
                i && a && ($(e).on(`focus${this.eventId}`, () => {
                    a.updateOptions({
                        lazy: !1
                    })
                }), $(e).on(`blur${this.eventId}`, () => {
                    if (!a.unmaskedValue) {
                        const t = a.mask.replace(/\*/g, "_"),
                            e = a.value;
                        a.updateOptions({
                            lazy: !0
        ...
        inputDate() {
            return this.hasCalendarField = !1, this.inModal || this.inCart ? this.$calendars.each((t, e) => {
                flexbe_cli.components.classes.form.initCalendar(e, this.$component.closest(".scroller")[0])
            }) : this.$calendars.each((t, e) => {
                flexbe_cli.components.classes.form.initCalendar(e)
            }), !0
        }
    }
    flexbe_cli.components.classes.formCaptcha = e, flexbe_cli.components.classes.form = i
}();
! function() {
    class e extends BaseComponent {
        constructor(...e) {
        ...
        getComponentSize() {
            return {
                width: this.core.tween.width,
                height: this.core.tween.height
            }
        }
        dispatchEffects() {
            var e, t;
            const s = e => [!0, 1, "true", "1"].includes(e),
                i = flexbe_cli.run.is_screen_mobile_all,
                n = s(null == (e = this.$component.attr("data-effects-desktop")) || e),
                o = s(null == (t = this.$component.attr("data-effects-mobile")) || t),
                a = i ? o : n;
    ...
    flexbe_cli.components.classes.form = class extends e {
        fileInput() {
            this.$form.on(`change${this.eventId}`, ".file-input--original", e => {
                ...
                if (i.addClass("active"), t.parents(".form-field").removeClass("is_error"), 1 === s && i.find(".file-item--title").text(l), s > 1) {
                    const e = s % 100,
                        t = s % 10,
                        l = Math.floor(e / 10);
                    let n;
                    n = 1 === t && 11 !== e ? "form.filesMult" : t > 1 && t < 5 && 1 !== l ? "form.filesMult1" : "form.filesMult2", i.find(".file-item--title").text(`${s} ${flexbe_cli.locale.tr(n)}`)
                }
...
function _extends() {
    ...
    const t = ".form-field-text__input, .dropdown-select",
        e = ".form-field-date__input",
        i = "next",
        s = "result";
    class a extends BaseComponent {
        constructor(...t) {
            ...
            e.getRecaptchaSettings().enabled && (this.captcha = new e({
                ...
                $form: this.$component,
                onSuccess: t => {
                    this.captchaRemoveError(), this.toResult({
                        force: !0
                    })
                },
                onError: () => {
        ...
        initControls() {
            $("body").off(`keydown${this.eventId}`).on(`keydown${this.eventId}`, t => {
                const e = 9 === t.keyCode,
                    i = 13 === t.keyCode;
                if (!i && !e) return;
                const s = flexbe_cli.block.hasOverlay || [],
                    a = this.rootModal && "modal" === s[s.length - 1],
                    r = !this.rootModal && !s.length,
                    n = this.inFocus && (r || a),
                    o = t.metaKey || t.ctrlKey,
                    l = t.shiftKey;
                if (n && ("TEXTAREA" !== t.target.tagName || !i || o)) {
                    if (l && e) this.toPrevStep();
                    else if (!l && !o) {
        ...
        toNextStep({
            ...
            const e = this.$currentStep.attr("data-goto"),
                s = this.$currentStep.attr("data-goal"),
                a = this.$currentStep.attr("data-html-goal"),
                r = this.history.find(t => t.id === this.currentId) || {},
                n = this.$currentStep.find("[data-field-id]").map((t, e) => {
                    ...
                    const h = c.toArray(),
                        p = h.map(t => t.getAttribute("data-goto")).filter(t => t);
                    return {
                        id: s,
                        title: o,
                        type: n,
                ...
                l = n.reduce((t, e) => t.concat(e.goto), []),
                c = this.getNextStep({
                    gotoId: l[0] || e || i
                });
        ...
        getNextStep({
            ...
            if (t === i && !a) return this.getNextStep({
                gotoId: s,
                $current: e
            });
        ...
        toStep({
            ...
            if (null == o && (o = this.history.find(t => t.id === this.currentId)), t === s) return void this.toResult({
                historyItem: o
            });
            ...
            const u = window.scrollParent(this.$component[0]) || document.scrollingElement,
                f = u && u.scrollTop || 0,
            ...
            return this.timeouts = this.timeouts.filter(t => clearTimeout(t)), this.timeouts.push(setTimeout(() => {
                ...
                const e = u.scrollTop,
                    i = this.$area.get(0).getBoundingClientRect().bottom - t.bottom - (f - e);
                i && u.scrollTo(0, e + i)
        ...
        checkResultCondition(t) {
            ...
            return !!r.length && (r = r["and" === i ? "every" : "some"](({
                condition: t,
                field: e
            }) => {
                let i = !0;
                ...
                if ("vars" === t.type) {
                    ...
                    const s = `${e.value}`.replace(/\s+/g, "").split(/\s[—-]\s/).map(t => +t).filter(t => "number" == typeof t && !isNaN(t)),
                        a = Math.min.apply(null, s),
                        r = Math.max.apply(null, s),
                        o = a !== r;
                    let l = +t.rangeLimitFrom,
                        c = +t.rangeLimitTo;
        ...
        checkField(t) {
            ...
            if (o) {
                ...
                } else if (l.length && "phone" == a)
                if (/[^0-9+\(\)\-\s]/.test(l)) c = "form.digits";
                else {
                    l.replace(/[^0-9]/g, "").length < 5 && (c = "form.minlength")
                }
            else if ("file" === a) c = !(!r || l.length) && "form.required";
            else if ("date" === a || "datetime" === a) {
        ...
        initFieldFile() {
            this.$component.off("change.uploadFile").on("change.uploadFile", ".file-input", t => {
                ...
                else if (1 === r) s.find(".text").text(a);
                else if (r > 1) {
                    const t = r % 100,
                        e = r % 10;
                    let i;
        ...
        initFieldSelect() {
            ...
            const t = this.$component.find("select.atom-custom-select"),
                e = {
                    dropdownClass: this.$component.hasClass("style-underlined") ? "sharp size--large" : "size--large"
                };
            t.each((t, i) => {
        ...
        // sendForm() {
        //     const t = this.captcha && this.captcha.getToken();
        //     if (this.captcha && this.captcha.enabled && !this.captcha.isOptional && !t) return void(this.captcha.isVisible ? this.toStep({
        //         id: "captcha"
        //     }) : this.captchaInvisibleRun());
        //     this.addSubmitting();
        //     const e = new FormData(this.$form.get(0));
        //     if (e.append("is_ajax", "true"), "undefined" != typeof flexbeAPI && void 0 !== flexbeAPI.customLeadData && e.append("customLeadData", JSON.stringify(flexbeAPI.customLeadData)), e.append("f_ab", JSON.stringify(flexbe_cli.stat.AB.getCookie())), "function" == typeof e.delete && e.delete("g-recaptcha-response"), t && e.append("captcha-token", t), flexbe_cli.run.is_OSX && "function" == typeof e.entries)
        //         for (const t of e.entries()) {
        //             const [i, s] = t;
        ...
        //         const i = 0 == e.status,
        //             s = i && e.captcha;
        //         if (this.captcha && s) t ? this.captchaAddError() : this.captcha.isVisible ? (this.captcha.isOptional = !1, this.total = parseInt(this.$component.attr("data-total-steps"), 10) + 1, this.clearSubmitting(!1), this.toStep({
        //             id: "captcha"
        ...
        initFieldMask() {
            return "undefined" != typeof IMask && (this.needInitMasks = !1, this.$masked.each((t, e) => {
                ...
                i && s && ($(e).on(`focus${this.eventId}`, () => {
                    ...
                    if (!s.unmaskedValue) {
                        const t = s.mask.replace(/\*/g, "_"),
                            e = s.value;
                        s.updateOptions({
                            lazy: !0
                        }), s.masked.rawInputValue && t !== e || (s.unmaskedValue = "", s.value = "", s.updateValue())
                    }
                }))
            }), !0)
        }
...
! function() {
    const t = flexbe_cli.components.classes.quiz;
    flexbe_cli.components.classes.quiz = class extends t {
        setProgress() {
            const t = this.$progress.find(".progress-loader-bar .current"),
            ...
            if (flexbe_cli.is_admin && -1 === this.realIndex && "welcome" !== this.currentId) {
                i = +this.$currentStep.prevAll('[data-linked="linked"]').first().attr("data-real-index") + 1 || 0
            }
            i = Math.max(0, Math.min(s - 1, i));
            const a = e ? i + 1 : i,
                l = parseInt(100 * a / s, 10);
            if (this.$progress.attr("data-current", a), this.$progress.attr("data-total", s), this.$progress.attr("data-current-progress", l > 0 ? l : 0), t && r) {
                const e = t.find(".progress-runner");
                let i = `${l}%`;
                "step" === r ? i = `${a} / ${s}` : "none" === r && (i = ""), e.attr("data-value", i)
            }
            this.$progress.find(".progress-text .current").text(a), this.$progress.find(".progress-text .total").text(s), this.$progress.find(".progress-percent .current").text(l), this.$progress.find(".progress-loader-bar .current").css("width", `${l}%`), this.$progress.find(".progress-loader-circle .current").attr("stroke-dashoffset", `${Math.abs(100-l)}`)
        }
        initFieldFile() {
            this.$form.on(`change.file${this.eventId}`, ".file-input--original", t => {
                const e = $(t.currentTarget),
                    r = e.parents(".file-input-outer"),
                    s = e.val(),
                    i = t.currentTarget.files.length;
                if (r.addClass("active"), e.closest("[data-type]").removeClass("is_error"), 1 === i) r.find(".file-item--title").text(s);
                else if (i > 1) {
                    const t = i % 100,
                        e = i % 10;
                    let s;
                    s = 1 === e && 11 !== t ? "form.filesMult" : e > 1 && e < 5 ? "form.filesMult1" : "form.filesMult2", r.find(".file-item--title").text(`${i} ${flexbe_cli.locale.tr(s)}`)
                } else r.removeClass("active")
            }), this.$form.on(`click${this.eventId}`, ".clear-files", t => {
                const e = $(t.currentTarget).parents(".file-input-outer");
                e.find(".file-input--original").val(""), e.removeClass("active")
            })
        }
    }
}();
! function() {
    class e extends BaseComponent {
        ...
        createListShowMore() {
            ...
            this.isRestored = !1;
            const t = this.$componentCopy.clone(),
                o = t.find("li.root-item").toArray();
            let i = 42,
                n = 0;
            t.appendTo("body").css({
                position: "absolute",
        ...
        openDropdown(e) {
            ...
            this.isOpen = !0, this.isOpenNested = !1, this.folder = e, this.$dropdown = $(`<div class="component-menu-dropdown ${t?"editor-focus":""}"></div>`), this.$dropdown.addClass(this.menuClasses), this.$dropdown.append(i).appendTo(o), this.setDropdownPosition(e), $("body").on(`click.menu-dropdown-${this.eventId} keydown.menu-dropdown-${this.eventId}`, e => {
                ...
                clearTimeout(this.nestedTimer), this.nestedTimer = setTimeout(() => {
                    this.currentTarget = null, this.closeNestedDropdown({
                        parentTarget: e.currentTarget.parentElement
                    }), this.isShowDropdownClick || this.closeDropdown()
                }, 200)
                ...
                clearTimeout(this.containerCloseTimer), this.closeNestedDropdown({
                    parentTarget: e.currentTarget
                }), this.containerCloseTimer = setTimeout(() => {
        ...
        closeDropdown(e) {
            ...
            const t = this.folder === e,
                o = e && $(e)[0].classList.contains("folder-item");
        ...
        openNestedDropdown({
            ...
            const o = $(t),
                ...
                m = this.bodyHeight < s.top + r + l,
                a = h.top > l,
                u = h.top + l > window.pageYOffset + window.innerHeight,
                f = flexbe_cli.block.hasOverlay || [],
                w = "modal" === f[f.length - 1],
                g = m && a || w && u;
        ...
        closeNestedDropdown({
            ...
            const o = $(t).find(".component-menu-dropdown-list"),
                i = this.folderDropdown === e,
        ...
        setDropdownPosition(e = this.folder) {
            ...
            const t = this.$dropdown,
                o = $(e).find(".component-menu-dropdown-list"),
                i = t.find(".component-menu-dropdown-list"),
                n = $(e).hasClass("show-more"),
                s = n ? $(e) : $(e).children().first(),
                r = s.innerWidth(),
                d = s.innerHeight(),
                h = s.offset(),
                l = h.top,
                ...
                p = o.innerWidth(),
                m = o.innerHeight(),
                a = c + p > window.innerWidth,
                u = c + c / 2 - (p / 2 + 20) < 0,
                f = l + d + m + 20 > this.bodyHeight,
                w = l + d + m > window.pageYOffset + window.innerHeight,
...
! function() {
    function e(e, i, s, t) {
        const a = $(e),
            l = i ? `[data-component="${i}"]` : "[data-component]";
    ...
    class i extends BaseComponent {
        ...
        sliderDisposer() {
            ...
            const e = flexbe_cli.run.is_screen_mobile_all,
                i = this.sliderResponsive,
        ...
        createSwiperSettings() {
            const e = flexbe_cli.run.is_screen_mobile_all,
                i = +this.$slider.attr("data-count"),
                s = +this.$slider.attr("data-cards"),
                t = +this.$slider.attr("data-cards-mobile") || 1,
                a = +this.$slider.attr("data-overflow"),
                l = e ? i <= t : i <= s;
            let r = 0;
            ...
            let n = this.$slider.attr("data-effect") || "slide",
                h = this.$slider.attr("data-effect-mobile") || "slide";
            ...
            if (l && p && (p = !1), p = !!p, this.freeSlides = 0, !a) {
                const e = this.$slider[0].offsetWidth,
                    i = e / s,
                    t = (flexbe_cli.resize.viewportWidth - e) / 2;
        ...
        createSwiperInstance() {
            ...
            const t = new Swiper(this.$slider[0], Object.assign({
                ...
                l = () => {
                    if (t.loopedSlides) {
                        const e = $(t.slides).filter(`.${t.params.slideDuplicateClass}`),
                            i = {};
                        e.each((e, s) => {
                            const t = $(s),
                                a = t.attr("data-swiper-slide-index");
                            i[a] = i[a] ? i[a] + 1 : 1, t.attr("data-cloned", i[a])
                        }), flexbe_cli.entity.initArea(e), flexbe_cli.components.initComponents({
                            core: this.core
                        })
                    }
                };
            t.once("init", () => {
                ...
                "slide" === t.params.effect ? (flexbe_cli.is_admin ? i.css({
                    ...
                    opacity: "",
                    transform: ""
                })) : "fade" === t.params.effect && i.css({
                    transform: ""
                })
            }), t.on("transitionStart touchStart", () => {
                this.$cardsRoot.addClass("slider-in-animation"), this.checkSlidesVisibility()
            }), t.on("transitionEnd touchEnd", () => {
                this.$cardsRoot.removeClass("slider-in-animation")
            }), this.$slider.on("preventSliderAutoplay", (e, {
                state: i = !0
            }) => {
                this.preventAutoplay = !!i, this.preventAutoplay && this.toggleAutoplay({
                    state: !1
                })
            }), this.$slider.on("preventSliderMove", (e, {
                state: i = !0
            }) => {
                t.allowTouchMove = !i
            }), this.swiper = t
        ...
        createSwiperNavigation() {
            ...
            e.once("init", () => {
                ...
                const s = i.currentTarget,
                    t = Array.from(e.slides).findIndex(e => e === s),
                    a = e.activeIndex,
                    l = a - t,
                    r = t - (a + e.params.slidesPerView - 1);
        ...
        createSwiperPagination() {
            ...
            e.on("paginationRender", () => {
                if ("bullets" === i.pagination.type)
                    if (e.loopedSlides) this.loopPagination = new flexbe_cli.components.classes.bulletsLoopPagination(this.$pagination[0], {
                        init: !1,
                        tag: "span",
                        onClick: e => {
                        ...
                        const s = i.pagination.bulletElement || "span",
                            t = i.pagination.bulletClass || "span",
                            a = i.slidesPerView || 1,
                            l = Math.ceil(this.totalSlides / a);
        ...
        checkSlidesVisibility() {
            ...
            i.updateSlides();
            const s = $(i.slides),
                t = s.slice(i.activeIndex, i.activeIndex + i.params.slidesPerView),
                a = s.not(t);
